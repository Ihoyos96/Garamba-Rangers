...
<?php
   ...
   if(isset($_POST['plot']) || isset($_POST['animate'])) {
     ...
     $sql = $db->query("SELECT * FROM `garamba` WHERE (`date` BETWEEN STR_TO_DATE('$start','%m/%d/%Y') AND STR_TO_DATE('$end','%m/%d/%Y')) ORDER BY `date` ASC");
